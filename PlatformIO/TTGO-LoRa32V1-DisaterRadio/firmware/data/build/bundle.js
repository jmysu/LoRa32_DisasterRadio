...
},{"deepmerge":6,"state-diff":9}],3:[function(require,module,exports){
'use strict'
...
},{"xtend":11}],10:[function(require,module,exports){
(function(nacl) {
'use strict';
...
},{"crypto":4}],11:[function(require,module,exports){
...
var self = module.exports = {
  ...
  showMessage: function showMessage(txt, type) {
    if (!type) type = 'remote';
    var msgs;
  ...
  showRoutes: function showRoutes(data) {
  ...
  sendMessage: function sendMessage(msg, cb) {
    ...
    var signature = _cipher2.default.sign(msg);
...
},{"../cipher.js":14}],13:[function(require,module,exports){
'use strict';
...
},{"./chat":12}],14:[function(require,module,exports){
(function (Buffer){
'use strict';
...
function init() {
  ...
  try {
    ...
    console.warn(e);
    app.keys = _tweetnacl2.default.sign.keyPair();
...
function sign(msg) {
  ...
  return _tweetnacl2.default.sign.detached(msg, app.keys.secretKey);
}
...
function verify(msg, signature, pubKey) {
  ...
  return _tweetnacl2.default.sign.detached.verify(msg, signature, pubKey);
}
...
},{"buffer":5,"tweetnacl":10}],15:[function(require,module,exports){
'use strict';
...
module.exports = function (Component) {
  ...
  return function (_Component) {
    ...
    function Chat(props) {
      ...
      app.socket.addListener('c', _this.receive);
      app.socket.addListener('r', _this.receiveRoutes);
      return _this;
    }
    ...
    _createClass(Chat, [{
      ...
      key: 'receive',
      value: function receive(namespace, data) {
        app.actions.chat.showMessage(data.toString('utf8'));
      }
    }, {
      key: 'receiveRoutes',
      value: function receiveRoutes(namespace, data) {
        var dataStr = '';
      ...
      value: function render() {
        ...
        var messages = this.state.messages.map(function (o) {
          ...
          return (0, _preact.h)(ChatMessage, { txt: o.txt, type: o.type });
        }, this);

        var routes = this.state.routes.map(function (o) {
          return (0, _preact.h)(RouteMessage, { rts: o });
        }, this);
        ...
        return (0, _preact.h)(
          ...
          (0, _preact.h)(
            'form',
            { id: 'chatForm', action: '/chat', method: 'POST', onsubmit: this.send },
            (0, _preact.h)(
              'div',
              { id: 'chat' },
              messages
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'u',
                  null,
                  'Active Nodes | Hops | Metric '
                )
              ),
              routes
            ),
            (0, _preact.h)('input', { id: 'chatInput', type: 'text', name: 'msg', placeholder: 'Enter you name or alias', autofocus: true })
          )
        );
      }
    }]);
...
},{"./chat_message":16,"./route_message":17,"preact":8}],16:[function(require,module,exports){
'use strict';
...
},{"preact":8}],17:[function(require,module,exports){
'use strict';
...
module.exports = function (Component) {
  ...
  return function (_Component) {
    _inherits(RouteMessage, _Component);

    function RouteMessage(props) {
      _classCallCheck(this, RouteMessage);

      var _this = _possibleConstructorReturn(this, (RouteMessage.__proto__ || Object.getPrototypeOf(RouteMessage)).call(this, props));

      _this.state = {};
      return _this;
    }

    _createClass(RouteMessage, [{
      key: 'render',
      value: function render() {
        return (0, _preact.h)(
          'div',
...
var _ashnazg = require('ashnazg');

var _ashnazg2 = _interopRequireDefault(_ashnazg);
...
var Component = (0, _ashnazg2.default)(_preact.Component);
...
function renderAll() {
  ...
  (0, _preact.render)((0, _preact.h)(Chat, { state: true }), container, replace);
}

function init() {
  app.socket = new _socket2.default('/ws', { debug: true });
...
},{"./actions/index":13,"./cipher.js":14,"./components/chat.js":15,"./socket.js":19,"ashnazg":2,"preact":8}],19:[function(require,module,exports){
(function (Buffer){
'use strict';
...
},{"arraybuffer-to-buffer":1,"buffer":5}]},{},[18]);
